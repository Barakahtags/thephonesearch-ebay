...
module.exports=async function(req,res){
  ...
  try{const t=await mps.authenticate();await mps.allParts(1,1);out.mps={ok:true,sessionTokenReceived:!!t,feedReady:true};}catch(e){out.ok=false;out.mps={ok:false,authenticationMayWork:true,feedReady:false,error:mps.publicError(e)};}
