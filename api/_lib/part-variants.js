...
const QUALITY = {
  ...
  refurbished: { label: 'Original Refurbished', title: 'Original Refurbished', condition: 'Generalüberholt', original: true, originalPanel: true, description: 'Professionell aufgearbeitetes Originaldisplay mit originalem LCD-/OLED-Panel. Frontglas und je nach Ausführung weitere Verschleißkomponenten wurden fachgerecht erneuert.' },
