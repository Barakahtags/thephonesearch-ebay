...
module.exports=async function(req,res){
  ...
  }catch(e){console.error('[api/catalog] failed',{page:req.query?.page,articleType:req.query?.articleType,error:String(e?.message||e),stack:e?.stack});res.status(503).json({ok:false,error:mps.publicError(e),supplierError:true});}
};
